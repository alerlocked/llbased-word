...
branch: main
updated_at: 2026-06-27T17:12:30+08:00
last_commit: 9161535
...
<!--AUTO:GIT-->
## 最近变更
- `9161535` chore: remove dead code (diagnose scripts, unused services/components) (1 second ago)
- `7326484` perf(vl_service): lazy-load mineru model to stop hot-reload reloads (29 hours ago)
- `e4c31ba` perf(mineru): batch VLM extraction + fix misleading config comments (29 hours ago)
- `016ecd3` chore(content-detail): wrap up done — content 32->461, op5 9->729 (6 days ago)
- `560e3ca` feat(g25a): extract assembly overview + inject as system_msg background (6 days ago)
- `27abdf2` feat(g25a): content prompt detail-expand (content_avg 32->461, zero fab) (6 days ago)
- `5b97f8d` fix(extract): _table_to_markdown grid-expand colspan/rowspan — op5 9->729 chars (6 days ago)
- `63776e8` chore(devlog): task_state running for content-detail (6 days ago)
- `c7b18b2` plan(content-detail): extract colspan fix + gen expand + assembly overview (6 days ago)
- `8125c3e` chore(content-quality): wrap up done — node B baseline + node A tighten 38->5 (6 days ago)
<!--/AUTO:GIT-->
