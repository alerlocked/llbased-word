...
branch: main
updated_at: 2026-07-05T11:44:57+08:00
last_commit: e3377e2
...
<!--AUTO:GIT-->
## 最近变更
- `e3377e2` test: xfail mineru 3.x suite + single-point edge failures (level-3 final) (0 seconds ago)
- `97bc969` test: xfail refactor-stale suites to quiet false-red noise (level-3 remainder) (10 minutes ago)
- `7b8b308` test: xfail review engine gaps + hybrid_parsing stale (level-3) (25 minutes ago)
- `e2ab5db` fix: table_merger continuation logic + LongTermMemory pydantic + review API (level-3) (46 minutes ago)
- `df0946d` fix(test): clean stale tests after refactor (level-2) (61 minutes ago)
- `c188f70` chore(test): upgrade pytest-asyncio 1.4.0 + register markers + remove orphan tests (70 minutes ago)
- `c0a7e83` fix(logging): rename LogRecord reserved attrs in structured logger kwargs (76 minutes ago)
